...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListWorkweekConfigsResponse :  IEquatable<ListWorkweekConfigsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ListWorkweekConfigsResponse(List<WorkweekConfig> WorkweekConfigs = default(List<WorkweekConfig>), string Cursor = default(string), List<Error> Errors = default(List<Error>))
        {
        ...
        [DataMember(Name="workweek_configs", EmitDefaultValue=false)]
        public List<WorkweekConfig> WorkweekConfigs { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WorkweekConfigs: ").Append(WorkweekConfigs).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ListWorkweekConfigsResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ListWorkweekConfigsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.WorkweekConfigs == other.WorkweekConfigs ||
                    this.WorkweekConfigs != null &&
                    this.WorkweekConfigs.SequenceEqual(other.WorkweekConfigs)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WorkweekConfigs != null)
                    hash = hash * 59 + this.WorkweekConfigs.GetHashCode();
                if (this.Cursor != null)
