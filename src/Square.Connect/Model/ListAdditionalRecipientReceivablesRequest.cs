...
namespace Square.Connect.Model
{
    ...
    public partial class ListAdditionalRecipientReceivablesRequest :  IEquatable<ListAdditionalRecipientReceivablesRequest>, IValidatableObject
    {
        ...
        public ListAdditionalRecipientReceivablesRequest(string BeginTime = default(string), string EndTime = default(string), string SortOrder = default(string), string Cursor = default(string))
        {
