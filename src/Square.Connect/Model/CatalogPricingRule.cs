...
namespace Square.Connect.Model
{
    ...
    public partial class CatalogPricingRule :  IEquatable<CatalogPricingRule>, IValidatableObject
    {
        ...
        /// <param name="ApplyProductsId">The &#x60;CatalogProductSet&#x60; to apply the pricing rule to within the set of matched products specified by &#x60;match_products_id&#x60;. An apply rule can only match once within the set of matched products. If left unset, the pricing rule will be applied to all products within the set of matched products..</param>
        ...
        /// </summary>
        /// <value>The &#x60;CatalogProductSet&#x60; to apply the pricing rule to within the set of matched products specified by &#x60;match_products_id&#x60;. An apply rule can only match once within the set of matched products. If left unset, the pricing rule will be applied to all products within the set of matched products.</value>
