...
namespace Square.Connect.Model
{
    ...
    public partial class ListRefundsRequest :  IEquatable<ListRefundsRequest>, IValidatableObject
    {
        ...
        public ListRefundsRequest(string BeginTime = default(string), string EndTime = default(string), SortOrderEnum? SortOrder = default(SortOrderEnum?), string Cursor = default(string))
        {
