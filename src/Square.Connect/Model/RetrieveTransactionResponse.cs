...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RetrieveTransactionResponse :  IEquatable<RetrieveTransactionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public RetrieveTransactionResponse(List<Error> Errors = default(List<Error>), Transaction Transaction = default(Transaction))
        {
            this.Errors = Errors;
