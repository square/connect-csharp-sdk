...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteCustomerCardResponse :  IEquatable<DeleteCustomerCardResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public DeleteCustomerCardResponse(List<Error> Errors = default(List<Error>))
        {
            this.Errors = Errors;
        }
