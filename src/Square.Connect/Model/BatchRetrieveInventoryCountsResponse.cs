...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BatchRetrieveInventoryCountsResponse :  IEquatable<BatchRetrieveInventoryCountsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public BatchRetrieveInventoryCountsResponse(List<Error> Errors = default(List<Error>), List<InventoryCount> Counts = default(List<InventoryCount>), string Cursor = default(string))
        {
            this.Errors = Errors;
            this.Counts = Counts;
            this.Cursor = Cursor;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BatchRetrieveInventoryCountsResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(BatchRetrieveInventoryCountsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
