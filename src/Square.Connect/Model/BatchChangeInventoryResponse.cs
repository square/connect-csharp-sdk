...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BatchChangeInventoryResponse :  IEquatable<BatchChangeInventoryResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public BatchChangeInventoryResponse(List<Error> Errors = default(List<Error>), List<InventoryCount> Counts = default(List<InventoryCount>))
        {
            this.Errors = Errors;
            this.Counts = Counts;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BatchChangeInventoryResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(BatchChangeInventoryResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
