...
namespace Square.Connect.Model
{
    ...
    public partial class Order :  IEquatable<Order>, IValidatableObject
    {
        ...
        /// <param name="CustomerId">The &#x60;Customer&#x60; ID of the customer associated with the order..</param>
