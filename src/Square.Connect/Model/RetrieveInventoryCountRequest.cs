...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RetrieveInventoryCountRequest :  IEquatable<RetrieveInventoryCountRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public RetrieveInventoryCountRequest(string LocationIds = default(string), string Cursor = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RetrieveInventoryCountRequest);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(RetrieveInventoryCountRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
