...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListPaymentRefundsResponse :  IEquatable<ListPaymentRefundsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="Refunds">The list of requested refunds..</param>
        ...
        public ListPaymentRefundsResponse(List<Error> Errors = default(List<Error>), List<PaymentRefund> Refunds = default(List<PaymentRefund>), string Cursor = default(string))
        {
            this.Errors = Errors;
        ...
        /// </summary>
        /// <value>The list of requested refunds.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ListPaymentRefundsResponse);
        }

        /// <summary>
        /// Returns true if ListPaymentRefundsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ListPaymentRefundsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListPaymentRefundsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
