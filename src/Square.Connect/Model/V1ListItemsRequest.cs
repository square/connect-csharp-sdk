...
namespace Square.Connect.Model
{
    ...
    [DataContract]
    [Obsolete]
    public partial class V1ListItemsRequest :  IEquatable<V1ListItemsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1ListItemsRequest" /> class.
        /// </summary>
        ...
        public V1ListItemsRequest(string BatchToken = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1ListItemsRequest);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(V1ListItemsRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
