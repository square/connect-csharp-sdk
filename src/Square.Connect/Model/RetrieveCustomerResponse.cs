...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RetrieveCustomerResponse :  IEquatable<RetrieveCustomerResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public RetrieveCustomerResponse(List<Error> Errors = default(List<Error>), Customer Customer = default(Customer))
        {
            this.Errors = Errors;
