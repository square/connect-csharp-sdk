...
namespace Square.Connect.Model
{
    ...
    public partial class CompletePaymentRequest :  IEquatable<CompletePaymentRequest>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompletePaymentRequest);
        }

        /// <summary>
        /// Returns true if CompletePaymentRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of CompletePaymentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompletePaymentRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
