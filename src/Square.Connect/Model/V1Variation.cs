...
namespace Square.Connect.Model
{
    ...
    public partial class V1Variation :  IEquatable<V1Variation>, IValidatableObject
    {
        ...
        /// <param name="Ordinal">ndicates the variation&#39;s list position when displayed in Square Register and the merchant dashboard. If more than one variation for the same item has the same ordinal value, those variations are displayed in alphabetical order.</param>
        ...
        /// </summary>
        /// <value>ndicates the variation&#39;s list position when displayed in Square Register and the merchant dashboard. If more than one variation for the same item has the same ordinal value, those variations are displayed in alphabetical order</value>
