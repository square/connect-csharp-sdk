...
namespace Square.Connect.Model
{
    ...
    public partial class CreateCustomerCardRequest :  IEquatable<CreateCustomerCardRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CreateCustomerCardRequest" /> class.
        /// </summary>
        /// <param name="CardNonce">A card nonce representing the credit card to link to the customer.  Card nonces are generated by the &#x60;SqPaymentForm&#x60; that buyers enter their card information into. See [Embedding the payment form](/payments/sqpaymentform/overview) for more information.  __Note:__ Card nonces generated by digital wallets (e.g., Apple Pay) cannot be used to create a customer card. (required).</param>
        ...
        /// </summary>
        /// <value>A card nonce representing the credit card to link to the customer.  Card nonces are generated by the &#x60;SqPaymentForm&#x60; that buyers enter their card information into. See [Embedding the payment form](/payments/sqpaymentform/overview) for more information.  __Note:__ Card nonces generated by digital wallets (e.g., Apple Pay) cannot be used to create a customer card.</value>
