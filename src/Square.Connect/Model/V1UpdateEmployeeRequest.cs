...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1UpdateEmployeeRequest :  IEquatable<V1UpdateEmployeeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1UpdateEmployeeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1UpdateEmployeeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1UpdateEmployeeRequest" /> class.
        /// </summary>
        ...
        public V1UpdateEmployeeRequest(V1Employee Body = default(V1Employee))
        {
            // to ensure "Body" is required (not null)
            if (Body == null)
            {
                throw new InvalidDataException("Body is a required property for V1UpdateEmployeeRequest and cannot be null");
            }
            else
            {
                this.Body = Body;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1UpdateEmployeeRequest);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(V1UpdateEmployeeRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
