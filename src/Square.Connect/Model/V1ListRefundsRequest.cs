...
namespace Square.Connect.Model
{
    ...
    public partial class V1ListRefundsRequest :  IEquatable<V1ListRefundsRequest>, IValidatableObject
    {
        ...
        public V1ListRefundsRequest(string Order = default(string), string BeginTime = default(string), string EndTime = default(string), int? Limit = default(int?), string BatchToken = default(string))
        {
            this.Order = Order;
