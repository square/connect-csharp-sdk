...
namespace Square.Connect.Model
{
    ...
    public partial class ListCustomersRequest :  IEquatable<ListCustomersRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Cursor">A pagination cursor returned by a previous call to this endpoint. Provide this to retrieve the next set of results for your original query.  See the [Pagination guide](https://developer.squareup.com/docs/working-with-apis/pagination) for more information..</param>
        ...
        public ListCustomersRequest(string Cursor = default(string), string SortField = default(string), string SortOrder = default(string))
        {
            this.Cursor = Cursor;
        ...
        /// </summary>
        /// <value>A pagination cursor returned by a previous call to this endpoint. Provide this to retrieve the next set of results for your original query.  See the [Pagination guide](https://developer.squareup.com/docs/working-with-apis/pagination) for more information.</value>
