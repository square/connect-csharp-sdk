...
namespace Square.Connect.Model
{
    ...
    public partial class ListTransactionsRequest :  IEquatable<ListTransactionsRequest>, IValidatableObject
    {
        ...
        public ListTransactionsRequest(string BeginTime = default(string), string EndTime = default(string), SortOrderEnum? SortOrder = default(SortOrderEnum?), string Cursor = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ListTransactionsRequest);
        }
