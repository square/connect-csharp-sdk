...
namespace Square.Connect.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAdditionalRecipientReceivableRefundsResponse" /> class.
        /// </summary>
        ...
        public ListAdditionalRecipientReceivableRefundsResponse(List<Error> Errors = default(List<Error>), List<AdditionalRecipientReceivableRefund> ReceivableRefunds = default(List<AdditionalRecipientReceivableRefund>), string Cursor = default(string))
        {
            this.Errors = Errors;
        ...
        [DataMember(Name="receivable_refunds", EmitDefaultValue=false)]
        public List<AdditionalRecipientReceivableRefund> ReceivableRefunds { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReceivableRefunds: ").Append(ReceivableRefunds).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ListAdditionalRecipientReceivableRefundsResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ListAdditionalRecipientReceivableRefundsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ReceivableRefunds == other.ReceivableRefunds ||
                    this.ReceivableRefunds != null &&
                    this.ReceivableRefunds.SequenceEqual(other.ReceivableRefunds)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReceivableRefunds != null)
                    hash = hash * 59 + this.ReceivableRefunds.GetHashCode();
                if (this.Cursor != null)
