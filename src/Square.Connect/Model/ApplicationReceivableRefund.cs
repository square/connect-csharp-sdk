...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApplicationReceivableRefund :  IEquatable<ApplicationReceivableRefund>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationReceivableRefund" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApplicationReceivableRefund() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationReceivableRefund" /> class.
        /// </summary>
        ...
        public ApplicationReceivableRefund(string Id = default(string), string ReceivableId = default(string), string RefundId = default(string), string TransactionLocationId = default(string), Money AmountMoney = default(Money), string CreatedAt = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for ApplicationReceivableRefund and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            {
                throw new InvalidDataException("ReceivableId is a required property for ApplicationReceivableRefund and cannot be null");
            }
            else
            {
            ...
            if (RefundId == null)
            {
                throw new InvalidDataException("RefundId is a required property for ApplicationReceivableRefund and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TransactionLocationId is a required property for ApplicationReceivableRefund and cannot be null");
            }
            else
            {
            ...
            if (AmountMoney == null)
            {
                throw new InvalidDataException("AmountMoney is a required property for ApplicationReceivableRefund and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ApplicationReceivableRefund);
        }

        /// <summary>
        /// Returns true if ApplicationReceivableRefund instances are equal
        /// </summary>
        /// <param name="other">Instance of ApplicationReceivableRefund to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationReceivableRefund other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
