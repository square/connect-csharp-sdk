...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteBreakTypeResponse :  IEquatable<DeleteBreakTypeResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public DeleteBreakTypeResponse(List<Error> Errors = default(List<Error>))
        {
            this.Errors = Errors;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DeleteBreakTypeResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(DeleteBreakTypeResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
