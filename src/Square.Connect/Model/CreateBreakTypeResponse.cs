...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateBreakTypeResponse :  IEquatable<CreateBreakTypeResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateBreakTypeResponse(BreakType BreakType = default(BreakType), List<Error> Errors = default(List<Error>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateBreakTypeResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CreateBreakTypeResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
