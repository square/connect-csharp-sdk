...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteShiftResponse :  IEquatable<DeleteShiftResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public DeleteShiftResponse(List<Error> Errors = default(List<Error>))
        {
            this.Errors = Errors;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DeleteShiftResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(DeleteShiftResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
