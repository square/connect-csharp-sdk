...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateCustomerCardResponse :  IEquatable<CreateCustomerCardResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateCustomerCardResponse(List<Error> Errors = default(List<Error>), Card Card = default(Card))
        {
            this.Errors = Errors;
            this.Card = Card;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateCustomerCardResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CreateCustomerCardResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
