...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateWorkweekConfigResponse :  IEquatable<UpdateWorkweekConfigResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateWorkweekConfigResponse(WorkweekConfig WorkweekConfig = default(WorkweekConfig), List<Error> Errors = default(List<Error>))
        {
        ...
        [DataMember(Name="workweek_config", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WorkweekConfig: ").Append(WorkweekConfig).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdateWorkweekConfigResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(UpdateWorkweekConfigResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.WorkweekConfig == other.WorkweekConfig ||
                    this.WorkweekConfig != null &&
                    this.WorkweekConfig.Equals(other.WorkweekConfig)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WorkweekConfig != null)
                    hash = hash * 59 + this.WorkweekConfig.GetHashCode();
                if (this.Errors != null)
