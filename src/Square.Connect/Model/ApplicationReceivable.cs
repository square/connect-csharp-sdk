...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApplicationReceivable :  IEquatable<ApplicationReceivable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationReceivable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApplicationReceivable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationReceivable" /> class.
        /// </summary>
        /// <param name="Id">The application receivable&#39;s unique ID, issued by Square payments servers. (required).</param>
        /// <param name="TransactionId">The ID of the transaction that the application receivable was applied to. (required).</param>
        ...
        /// <param name="CreatedAt">The time when the application receivable was created, in RFC 3339 format..</param>
        /// <param name="Refunds">Any refunds of the receivable that have been applied..</param>
        public ApplicationReceivable(string Id = default(string), string TransactionId = default(string), string TransactionLocationId = default(string), Money AmountMoney = default(Money), string CreatedAt = default(string), List<ApplicationReceivableRefund> Refunds = default(List<ApplicationReceivableRefund>))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for ApplicationReceivable and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            {
                throw new InvalidDataException("TransactionId is a required property for ApplicationReceivable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TransactionLocationId is a required property for ApplicationReceivable and cannot be null");
            }
            else
            {
            ...
            if (AmountMoney == null)
            {
                throw new InvalidDataException("AmountMoney is a required property for ApplicationReceivable and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The application receivable&#39;s unique ID, issued by Square payments servers.</value>
        [DataMember(Name="id", EmitDefaultValue=false)]
        public string Id { get; set; }
        /// <summary>
        /// The ID of the transaction that the application receivable was applied to.
        /// </summary>
        /// <value>The ID of the transaction that the application receivable was applied to.</value>
        ...
        /// </summary>
        /// <value>The time when the application receivable was created, in RFC 3339 format.</value>
        ...
        public List<ApplicationReceivableRefund> Refunds { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ApplicationReceivable);
        }

        /// <summary>
        /// Returns true if ApplicationReceivable instances are equal
        /// </summary>
        /// <param name="other">Instance of ApplicationReceivable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationReceivable other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
