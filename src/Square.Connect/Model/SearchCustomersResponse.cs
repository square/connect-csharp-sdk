...
namespace Square.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SearchCustomersResponse :  IEquatable<SearchCustomersResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="Cursor">A pagination cursor that can be used during subsequent calls to SearchCustomers to retrieve the next set of results associated with the original query. Pagination cursors are only present when a request succeeds and additional results are available.  See [Paginating results](#paginatingresults) for more information..</param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SearchCustomersResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(SearchCustomersResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
