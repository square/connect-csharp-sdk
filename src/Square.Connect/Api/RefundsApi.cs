...
namespace Square.Connect.Api
{
    ...
    public interface IRefundsApi : IApiAccessor
    {
        ...
        /// <param name="status">If provided, only refunds with the given status are returned.  For a list of refund status values, see [PaymentRefund](#type-paymentrefund).  Default: If omitted refunds are returned regardless of status. (optional)</param>
